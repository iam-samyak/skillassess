      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block" style="background:url('images/logo.png');background-position: center;
    background-size: auto;background-repeat: no-repeat;"></div>
              <div class="col-lg-6">
                <div class="p-5">
				...
				?>
					...
					<?php if($hres[0]['setting_value']==""){ ?>Assessment <?php }else{ echo $hres[0]['setting_value']; }?> 
					
					</h1>
          <h6>Career Development Cell</h6>
                  </div>
...
if($this->config->item('open_quiz')){
	?>			 
			...
			?>
				  ...
				  <p style="margin-top:40px;""><a class="small" href="http://skillassess.co.in/" style="float:right;">Powered by Skill Assess</a></p>
