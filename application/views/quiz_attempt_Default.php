...
document.addEventListener('DOMContentLoaded', () => {
    ...
    navigator.mediaDevices.getUserMedia({ video: true, audio: true })
        .then((mediaStream) => {
            // The webcam is turned on, and the user has granted permission.
            // You can now start capturing images and recording.
            ...
            // Capture images at a 2-minute interval
            captureInterval = setInterval(captureImage, 120000); // 2 minutes
    ...
    function captureImage() {
        ...
        videoElement.addEventListener('loadedmetadata', () => {
            // Create a canvas and draw the current frame from the video
            ...
            a.href = imageDataUrl;
            a.download = `image${imageCount}.png`; // You can customize the file name
            a.click();
