...
if(in_array($option['oid'],$save_ans)){   echo  trim($option['q_option']).', '; }?> 
	...
	// short answer	
		...
		<a href="javascript:assign_score('<?php echo $result['rid'];?>','<?php echo $qk;?>','1');"  class="btn btn-success" >Correct</a>	
		<a href="javascript:assign_score('<?php echo $result['rid'];?>','<?php echo $qk;?>','2');"  class="btn btn-danger" >Wrong</a>	
		<!-- <a href="javascript:assign_score('<?php echo $result['rid'];?>','<?php echo $qk;?>','C');"  class="btn btn-success" >C</a>	 -->
		</div>
		<?php 
			}
		}
