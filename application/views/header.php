...
<?php 
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="http://skillassess.co.in">
         
        <div class="sidebar-brand-text mx-3"><?php if($hres[0]['setting_value']==""){ ?>Skill Assess <?php }else{ echo $hres[0]['setting_value']; }?> </div>
...
?>			
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo site_url('result');?>">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span><?php echo $this->lang->line('result');?></span></a>
      </li>
<?php } ?>
      <!-- Divider -->
